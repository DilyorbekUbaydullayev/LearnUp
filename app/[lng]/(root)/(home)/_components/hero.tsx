...
function Hero() {
	...
	return (
		<>
			<div className='container mx-auto mt-6 grid min-h-[80vh] max-w-6xl grid-cols-2 gap-8 max-md:grid-cols-1 max-md:pt-32'>
				...
				>
					<CarouselContent>
						{companies.map((Icon, idx) => (
							...
							>
								<Icon className='h-20 w-full text-muted-foreground' />
							</CarouselItem>
						))}
					</CarouselContent>
				</Carousel>
